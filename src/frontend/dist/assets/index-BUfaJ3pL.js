  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "0 24px 16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
...
function tickSimulation(nodes, links, W, H) {
  ...
  for (const n of nodes) {
    ...
    n.vx += (W / 2 - n.x) * 2e-3 * alpha;
    n.vy += (H / 2 - n.y) * 2e-3 * alpha;
    for (const m of nodes) {
      if (n === m) continue;
      const dx = n.x - m.x;
      const dy = n.y - m.y;
      const dist2 = dx * dx + dy * dy || 1;
      const f = 4e3 * alpha / dist2;
      n.vx += dx * f;
      n.vy += dy * f;
    }
  }
...
function GraphView({ onSelectItem }) {
  ...
  const getCanvasPos = reactExports.useCallback(
    (e, canvas) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "0", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    style: {
                ...
                geomOptions.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "1px", height: "28px", background: "#000" } })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "16px", marginLeft: "auto" }, children: legend.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
