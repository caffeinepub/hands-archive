      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "Philadelphia, PA · Post-Rock Archive"
          }
        )
      ]
    }
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "R = Random" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "G = Graph" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "T = Timeline" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "E = Archive" })
            ]
          }
        )
      ]
...
function getRelatedItems(item) {
  ...
  if (item.type === "album") {
    const tracks = item.trackList.map((id) => SONGS.find((s) => s.id === id)).filter(Boolean);
    return tracks;
  }
  if (item.type === "member") {
    return ALBUMS;
...
function ArchiveCard({ item, onClick, "data-ocid": ocid }) {
...
function ArchiveView({ onSelectItem }) {
  const [filter, setFilter] = reactExports.useState("all");
  const filtered = filter === "all" ? ALL_ITEMS : ALL_ITEMS.filter((i) => i.type === filter);
  const filters = [
    { key: "all", label: "All" },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "48px 48px 64px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: filtered.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "#fff" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ArchiveCard,
          {
            item,
            onClick: onSelectItem,
            "data-ocid": idx < 3 ? `archive.item.${idx + 1}` : void 0
          }
        ) }, item.id))
      }
    )
...
function DetailView({ item, onBack, onSelectItem }) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              item.type === "song" && [
              ...
              ].map(({ key, val }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", padding: "16px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 700, fontSize: "16px" }, children: val })
              ] }, key)),
              item.type === "album" && [
                { key: "Year", val: String(item.year) },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: item.type === "member" ? item.bio : item.description
          }
        ),
        item.type === "album" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "48px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { flex: 1, fontWeight: 600, fontSize: "14px" }, children: song.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
        ...
        item.type === "song" && (() => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "48px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { maxWidth: "400px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveCard, { item: album, onClick: onSelectItem }) })
          ] });
        })(),
        related.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: related.map((rel) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "#fff" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveCard, { item: rel, onClick: onSelectItem }) }, rel.id))
            }
          )
        ] })
      ]
...
function buildGraph(W, H) {
  const cx = W / 2;
  const cy = H / 2;
  const nodes = ALL_ITEMS.map((item) => ({
    id: item.id,
    label: item.type === "member" ? item.name : item.title,
    type: item.type,
...
function tickSimulation(nodes, links, W, H) {
  const alpha = 0.25;
  ...
  for (const link of links) {
    ...
    const target = 110;
    const f = (dist - target) * 8e-3 * alpha;
    const fx = dx / dist * f;
    const fy = dy / dist * f;
    if (s.fx === null) {
      s.vx += fx;
  ...
  for (const n of nodes) {
    ...
    n.vx += (cx - n.x) * 1e-3 * alpha;
    n.vy += (cy - n.y) * 1e-3 * alpha;
...
function fitNodesToView(nodes, W, H, padding = 60) {
  ...
  for (const n of nodes) {
    const r = (NODE_SIZES[n.type] ?? 7) + 14;
  ...
  const k = Math.min(
    ...
    (H - padding * 2) / graphH,
    0.55
    // don't zoom in beyond 0.55x — keeps full graph visible
  );
  const x = W / 2 - (minX + maxX) / 2 * k;
  const y = H / 2 - (minY + maxY) / 2 * k;
  return { x, y, k };
}
function applyGeometry(nodes, mode, cx, cy) {
  if (mode === "flower") {
...
function GraphView({ onSelectItem }) {
  const canvasRef = reactExports.useRef(null);
  const containerRef = reactExports.useRef(null);
  const [geometry, setGeometry] = reactExports.useState("standard");
  const geometryRef = reactExports.useRef("standard");
  const hoveredIdRef = reactExports.useRef(null);
  const nodesRef = reactExports.useRef([]);
  const linksRef = reactExports.useRef([]);
  const transformRef = reactExports.useRef({ x: 0, y: 0, k: 0.6 });
  const sizeRef = reactExports.useRef({ W: 0, H: 0 });
  ...
  const dragStartRef = reactExports.useRef({ x: 0, y: 0, tx: 0, ty: 0 });
  const dragNodeRef = reactExports.useRef(null);
  const hasFitRef = reactExports.useRef(false);
  const touchStartRef = reactExports.useRef({ x: 0, y: 0, tx: 0, ty: 0 });
  const isTouchPanRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
    geometryRef.current = geometry;
  }, [geometry]);
  const getWorldPos = reactExports.useCallback(
    (e, canvas) => {
  ...
  const findNode = reactExports.useCallback((mx, my) => {
    let found = null;
    ...
    (ctx, _canvas) => {
      ...
      function draw() {
        ...
        for (const node of nodesRef.current) {
          ...
          ctx.fill();
          ctx.stroke();
          const label = node.label.length > 16 ? `${node.label.substring(0, 15)}…` : node.label;
          ctx.fillStyle = "#000";
      ...
      function loop() {
        const { W, H } = sizeRef.current;
        if (W > 0 && H > 0) {
          const shouldSimulate = frameRef.current < 220 || dragNodeRef.current !== null;
          if (shouldSimulate) {
            tickSimulation(nodesRef.current, linksRef.current, W, H);
            frameRef.current++;
            if (frameRef.current === 120 && !hasFitRef.current && geometryRef.current === "standard") {
  ...
  reactExports.useEffect(() => {
    ...
    const onMouseMove = (e) => {
      if (dragNodeRef.current) {
        const { mx: mx2, my: my2 } = getWorldPos(e, canvas);
        dragNodeRef.current.fx = mx2;
        dragNodeRef.current.fy = my2;
        frameRef.current = 0;
        return;
      }
      if (isDraggingRef.current) {
        transformRef.current.x = dragStartRef.current.tx + (e.clientX - dragStartRef.current.x);
        transformRef.current.y = dragStartRef.current.ty + (e.clientY - dragStartRef.current.y);
        frameRef.current = Math.min(frameRef.current, 220);
        return;
      }
      const { mx, my } = getWorldPos(e, canvas);
      const hovered = findNode(mx, my);
      const newId = (hovered == null ? void 0 : hovered.id) ?? null;
    ...
    const onMouseUp = (e) => {
      if (dragNodeRef.current) {
        const moved = dragNodeRef.current.fx !== null && Math.abs(dragNodeRef.current.fx - dragNodeRef.current.x) < 4 && Math.abs(dragNodeRef.current.fy - dragNodeRef.current.y) < 4;
        if (moved) {
    ...
    const onTouchMove = (e) => {
      ...
      e.preventDefault();
      const touch = e.touches[0];
      transformRef.current.x = touchStartRef.current.tx + (touch.clientX - touchStartRef.current.x);
      transformRef.current.y = touchStartRef.current.ty + (touch.clientY - touchStartRef.current.y);
      frameRef.current = Math.min(frameRef.current, 220);
    };
    const onTouchEnd = () => {
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [
                ...
                geomOptions.map((opt, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: legend.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "Scroll to zoom · Drag canvas to pan · Drag nodes to move · Click to view"
                }
              )
            ]
          }
...
function HomeView({ onSelectItem }) {
  const latestAlbum = ALBUMS[ALBUMS.length - 1];
  const recentShows = SHOWS.slice(-2).reverse();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "48px 48px 64px", maxWidth: "960px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "64px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Hands is a Philadelphia-based post-rock trio active since 2008. Their music occupies the space between noise and silence, texture and rhythm."
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { maxWidth: "480px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveCard, { item: latestAlbum, onClick: onSelectItem }) })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderTop: "1px solid black", paddingTop: "32px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: recentShows.map((show) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "#fff" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveCard, { item: show, onClick: onSelectItem }) }, show.id))
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { textTransform: "uppercase", letterSpacing: "0.1em" }, children: "HANDS Archive" })
        ]
      }
    )
  ] });
...
const PRESS_ITEMS = [
  {
    ...
    outlet: "Pitchfork",
    date: "2011-09-12",
    headline: '"Synesthesia" is a debut that announces a band unafraid of space.',
    score: "7.8"
  },
  {
    id: "wire-2013",
    outlet: "The Wire",
    date: "2013-11-04",
    headline: "Wildly Idle positions Hands as one of the most uncompromising voices in post-rock.",
    score: null
  },
  {
    id: "exclaim-2016",
...
function MediaView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "48px 48px 64px", maxWidth: "800px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "48px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: PRESS_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                background: "#fff",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flexShrink: 0, width: "100px" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                  ...
                  item.score && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        marginTop: "8px",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: "Discography at a Glance"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: ["Synesthesia (2011)", "Wildly Idle (2013)", "Cavalo (2016)"].map(
...
function MusicView({ onSelectItem }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "48px 48px 64px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: "48px" }, children: ALBUMS.map((album) => {
      const tracks = SONGS.filter((s) => album.trackList.includes(s.id));
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveCard, { item: album, onClick: onSelectItem }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
            ...
            children: [
              ...
              tracks.map((song, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => onSelectItem(song),
...
function ShowsView({ onSelectItem }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "48px 48px 64px", maxWidth: "800px" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#666", fontSize: "14px", marginBottom: "40px" }, children: "Documented performances, festivals, and tours." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: sorted.map((show) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "#fff" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveCard, { item: show, onClick: onSelectItem }) }, show.id))
      }
    )
  ] });
}
function TimelineView({ onSelectItem }) {
  const entries = [
    ...ALBUMS.map((a) => ({
      id: a.id,
      year: a.year,
...
function App() {
  ...
  const [prevView, setPrevView] = reactExports.useState("home");
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flex: 1, overflow: "hidden" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { currentView, onNavigate: navigateTo }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "main",
            {
              style: {
              ...
              children: [
                currentView === "home" && /* @__PURE__ */ jsxRuntimeExports.jsx(HomeView, { onSelectItem: openDetail }),
                currentView === "music" && /* @__PURE__ */ jsxRuntimeExports.jsx(MusicView, { onSelectItem: openDetail }),
                currentView === "archive" && /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveView, { onSelectItem: openDetail }),
                currentView === "shows" && /* @__PURE__ */ jsxRuntimeExports.jsx(ShowsView, { onSelectItem: openDetail }),
                currentView === "media" && /* @__PURE__ */ jsxRuntimeExports.jsx(MediaView, {}),
                currentView === "graph" && /* @__PURE__ */ jsxRuntimeExports.jsx(GraphView, { onSelectItem: openDetail }),
                currentView === "timeline" && /* @__PURE__ */ jsxRuntimeExports.jsx(TimelineView, { onSelectItem: openDetail }),
                currentView === "detail" && selectedItem && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  DetailView,
                  {
                    item: selectedItem,
                    onBack: goBack,
...
const MemberType = Record({
  "id": Text,
  "bio": Text,
  "name": Text,
  "role": Text,
  "years": Tuple(Nat, Opt(Nat))
});
const PhotoType = Record({
  "id": Text,
  "url": Text,
  "title": Text,
  "year": Nat,
...
const RelatedType = Variant({
  "members": Vec(MemberType),
  "albums": Vec(AlbumType),
  "shows": Vec(ShowType),
  "songs": Vec(SongType),
  "press": Vec(PressType),
  "videos": Vec(VideoType),
  "photos": Vec(PhotoType)
});
const RelatedItem = Record({ "relatedType": RelatedType });
const Related = Record({
  "id": Text,
  "relatedItems": Vec(RelatedItem),
  "relatedType": RelatedType
});
Service({
  "createAlbum": Func(
    [Text, Text, Nat, Text, Vec(Text)],
    [],
    []
  ),
  "createMember": Func(
    [Text, Text, Text, Text, Nat, Opt(Nat)],
    [],
    []
  ),
  "createPhoto": Func(
    [Text, Text, Text, Text, Nat],
    [],
    []
  ),
  "createPress": Func(
    [Text, Text, Text, Time, Text, Text],
    [],
    []
  ),
  "createShow": Func(
  ...
  "createSong": Func(
    [Text, Text, Text, Nat, Nat, Text, Text],
    [],
    []
  ),
  "createVideo": Func(
  ...
  "deleteAlbum": Func([Text], [], []),
  "deleteMember": Func([Text], [], []),
  "deletePhoto": Func([Text], [], []),
  "deletePress": Func([Text], [], []),
  "deleteShow": Func([Text], [], []),
  "deleteSong": Func([Text], [], []),
  "deleteVideo": Func([Text], [], []),
  "getAlbum": Func([Text], [AlbumType], ["query"]),
  "getAllAlbums": Func([], [Vec(AlbumType)], ["query"]),
  "getAllMembers": Func([], [Vec(MemberType)], ["query"]),
  "getAllPhotos": Func([], [Vec(PhotoType)], ["query"]),
  "getAllPress": Func([], [Vec(PressType)], ["query"]),
  "getAllShows": Func([], [Vec(ShowType)], ["query"]),
  "getAllSongs": Func([], [Vec(SongType)], ["query"]),
  "getAllVideos": Func([], [Vec(VideoType)], ["query"]),
  "getMember": Func([Text], [MemberType], ["query"]),
  "getPhoto": Func([Text], [PhotoType], ["query"]),
  "getPress": Func([Text], [PressType], ["query"]),
  "getRelated": Func([Text], [Related], ["query"]),
  "getShow": Func([Text], [ShowType], ["query"]),
  "getSong": Func([Text], [SongType], ["query"]),
  "getVideo": Func([Text], [VideoType], ["query"]),
  "updateAlbum": Func(
    [Text, Text, Nat, Text, Vec(Text)],
    [],
    []
